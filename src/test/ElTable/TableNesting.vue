        ...
        <template slot-scope="scope">
          ...
          <div v-for="item in (scope.row.ext)" :key="item.id">
            <el-table :data="item" border :class="item!==scope.row.ext.default?'tab-thead-style':''" style="box-sizing: border-box;border-top:none;" :span-method="objectSpanMethod">
              <el-table-column :label="item===scope.row.ext.default?'运送到':''" prop="area" />
              <el-table-column :label="item===scope.row.ext.default?'首重':''" prop="weight" />
              <el-table-column :label="item===scope.row.ext.default?'运费':''" prop="first_price" />
              <el-table-column :label="item===scope.row.ext.default?'续重':''" prop="weight_incre" />
              <el-table-column :label="item===scope.row.ext.default?'最终运费':''" prop="extend_price" />
            </el-table>
          </div>
